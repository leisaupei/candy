...
{
	public class PostgreSqlDbConnectionOption : ICreeperDbConnectionOption
	{
		/// <summary>
		/// 初始化
		/// </summary>
		...
		public PostgreSqlDbConnectionOption(string connectionString, string dbName, DbConnectionOptions options)
		{
